...
class UserModel {
    static async create(userData) {
        ...
        const result = await database_1.default.query('INSERT INTO users (username, email, password_hash) VALUES ($1, $2, $3) RETURNING *', [username, email, passwordHash]);
    ...
    static async updatePassword(userId, newPassword) {
        ...
        await database_1.default.query('UPDATE users SET password_hash = $1 WHERE id = $2', [passwordHash, userId]);
    }
}
